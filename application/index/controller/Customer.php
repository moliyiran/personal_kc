...
use \think\Request;
use think\Db; 
class Customer extends \app\index\controller\Common
{
	public $dbinfo='';
    ...
    public function add(){
        if(!empty($_POST)){
            ...
            $exe_result=$cate_result=Db::name('customer')->insert($data);
            if($exe_result){
                suc();
            }else{
                err();
